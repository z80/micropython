#define MICROPY_HW_BOARD_NAME       "F405_OVERRIDE"
...
// LEDs
#define MICROPY_HW_LED_INVERTED     (0) // LEDs are on when pin is driven low
#define MICROPY_HW_LED1             (pin_A15)  // R1 - red
#define MICROPY_HW_LED2             (pin_C10) // R2 - red
